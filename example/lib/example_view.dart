...
import 'package:fluter_dsystem/fluter_dsystem.dart';
...
class ExampleView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: BoxText.body("Exemplo de Design System"),
      ),
      body: ListView(
  ...
  List<Widget> get textWidgets => [
    ...
    verticalSpaceMedium,
    const BoxText.caption('This will be the caption usually for smaller details'),
    verticalSpaceMedium,
  ];
